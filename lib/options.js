...
Options.prototype.extend = function (opts) {
    ...
    // set global sourcemaps options from preprocessors
    options = this.setGlobalSourcemaps(options);
