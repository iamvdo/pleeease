...
Preprocessor.prototype.less = function () {
  ...
  if (this.sourcemaps) {
    ...
    opts.sourceMap.sourceMapBasepath = opts.sourceMap.sourceMapBasepath || path.relative(process.cwd(), absPath);
    opts.sourceMap.sourceMapRootpath = opts.sourceMap.sourceMapRootpath || path.relative(path.dirname(this.sourcemaps.to), opts.sourceMap.sourceMapBasepath);
  }
