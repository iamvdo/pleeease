 ...
 *
 * Pipe all modules
 * Useful to use it as a plugin
 * @param  {String} css
 * @return {Object} Pipeline
 *
 */
Pleeease.prototype.pipeline = function (css) {
...
pleeease.process = function (css, options) {
    ...
    if (arguments.length === 0) {
        return new Logger.error('CSS missing in pleeease.process()');
    }
    ...
    try {
        ...
        return new Logger.error(err.message);
    }
