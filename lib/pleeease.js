 ...
 *
 */
Pleeease.prototype.parse = function (css, opts) {

    var from = '<no-source>';
    var to   = '<no-output>';

    if (opts.sourcemaps && !opts.sourcemaps.from) {
        opts.sourcemaps.from = from;
    }
    if (opts.sourcemaps && !opts.sourcemaps.to) {
    ...
    return postcss.parse(css, opts.sourcemaps);
...
pleeease.process = function (css, options) {
    ...
    this.processor = new Pleeease(options);

    var opts = this.processor.options;
    ...
    */
    ...
    try {
        ...
        css = this.processor.parse(css, opts);
        //return this.processor.process(css, sourcemaps);
    } catch (err) {
